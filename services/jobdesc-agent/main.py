...
@app.post("/invoke")
def invoke():
    """IMPORTANTE: el frontend debe reenviar el MISMO session_id en cada
    turno de una misma conversación (este agente hace varias preguntas antes
    de dar la Job Description final), para que ADK conserve el contexto."""
